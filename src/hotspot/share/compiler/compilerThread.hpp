...
class CompilerThread : public JavaThread {
 ...
 public:
  ...
  // Get/set the thread's logging information
  fileStream* objectsESLog() { return _objectsESLog; }
  void          init_ObjectsESLog(fileStream* objectsESLog) {
    // Set once, for good.
    assert(_objectsESLog == NULL, "set only once");
    _objectsESLog = objectsESLog;
  }
